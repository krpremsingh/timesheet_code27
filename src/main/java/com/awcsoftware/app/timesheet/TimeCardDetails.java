...
public class TimeCardDetails implements Serializable {
	...
	public String toString() {
		return "TimeCardDetails [tcdId=" + tcdId + ", tcId=" + tcId + ", projectId=" + projectId + ", activityId="
				+ activityId + ", taskDetails=" + taskDetails + ", workingDay=" + workingDay + ", workingDate="
				+ workingDate + ", workingHours=" + workingHours + ", status=" + status + ", comments=" + comments
				+ ", addedOn=" + addedOn + ", lastModifiedOn=" + lastModifiedOn + ", timeCardApprovalDetails="
