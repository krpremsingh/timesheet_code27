 ...
 *//**
	 ...
	 *
	 *//*
		 * public class TimeCardValidatorTest { public static void main(String[] args) {
		 * TimecardInfo tci=new TimecardInfo(); tci.setEmpId(1277);
		 * tci.setWeekStart(LocalDate.now());
		 * tci.setWeekEnd(LocalDate.now().plusDays(7)); tci.setTotalHours("20");
		 * 
		 * TimecardDetails tcd1=new TimecardDetails();
		 * tcd1.setWorkingDate(LocalDate.now()); TimecardDetails tcd2=new
		 * TimecardDetails(); tcd2.setWorkingDate(LocalDate.now().plusDays(1));
		 * TimecardDetails tcd3=new TimecardDetails();
		 * tcd3.setWorkingDate(LocalDate.now().plusDays(2)); TimecardDetails tcd4=new
		 * TimecardDetails(); tcd4.setWorkingDate(LocalDate.now().plusDays(3));
		 ...
		 * tci.setTimeCardDetails(list); TimecardValidator tcv=new TimecardValidator();
		 * 
